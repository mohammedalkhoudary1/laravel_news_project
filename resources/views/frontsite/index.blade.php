        ...
        <div class="col-md-6">
            <div class="row">
                ...
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img src="{{ asset('post_images/'. $post->large_image) }}" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="{{ route('frontsite.single', $post) }}" class="color_fff"> <i class="fa fa-clock-o"></i>&nbsp;&nbsp;{{ $post->created_at }} </a></div>
                            <div class=""><a href="{{ route('frontsite.single', $post) }}" class="fh5co_good_font_2"> {{ $post->title }}</a></div>
                        </div>
                    </div>
                </div>
                @endforeach
