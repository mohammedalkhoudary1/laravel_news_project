        ...
        <div class="card card-primary">
          ...
          <div class="card-body">
            ...
            <div class="form-group">
              ...
              <textarea id="body" name="body" value="{{ old('body') }}" class="form-control" rows="4"></textarea>
            </div>
            ...
            <div class="form-group">
              ...
              <select id="category_id" name="category_id" value="{{ old('category_id') }}" class="form-control custom-select">
